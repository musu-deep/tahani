...
const INITIAL_POSTS: CelebrationPost[] = [
  ...
  },
  {
    ...
    message: 'يسرنا أن نزف أطيب وأرق التهاني والتبريكات لابننا العبقري "أحمد البشير" بمناسبة حصوله على المجموع الاستثنائي 96.5% في الشهادة الثانوية. لقد كنت دائماً رمزاً للمثابرة والأخلاق العالية، وها قد رفعت رأساً عالياً وشققت درب المعالي بفخر واعتزاز.',
  ...
  },
  {
    ...
    message: 'مبروك يا بطل يا حبيب والدتك "مازن عوض"! كلووولووووللي! نجاحك اليوم في شهادة الابتدائي بمجموع 248 هو أسعد خبر ملا بيتنا فرح وهناء وعقبال تفوق الشهادة المتوسطة والثانوية دايماً في الصدارة يا حبيبي.',
